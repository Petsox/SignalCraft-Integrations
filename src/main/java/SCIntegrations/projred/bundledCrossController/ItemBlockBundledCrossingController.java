...
public class ItemBlockBundledCrossingController extends SCItemBlock
{
    public ItemBlockBundledCrossingController(Block block) {
        super(block);
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par4) {
        list.add(EnumChatFormatting.BOLD + I18n.format("gui.item.bundledCrossController.use"));
        list.add(I18n.format("gui.item.bundledActivated"));
